...
public class ErrorMessageConstants {
    ...
    public static String COURSE_STUDENT_MAX_NUMBER_FULL = "A maximum of 20 students can take this course at the same time.";
    public static final String DATE_FORMAT_WRONG = "Date for transaction is wrong :";
}
